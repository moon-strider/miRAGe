...
Long-document question answering benchmark over NLP research papers for RAG runs that need section-aware retrieval, long-context chunking, and evidence grounding across full documents.
