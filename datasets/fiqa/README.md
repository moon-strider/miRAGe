...
Financial question-answering retrieval benchmark for RAG evaluations that need domain jargon, practical user queries, and a mixture of semantic lookup with exact factual retrieval.
